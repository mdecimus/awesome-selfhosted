...
- [Stalwart Mail Server](https://stalw.art/) - All-in-one mail server with JMAP, IMAP and SMTP support and a wide range of modern features. Designed to be secure, fast, robust and scalable. ([Source Code](https://github.com/stalwartlabs/mail-server)) `AGPL-3.0` `Rust`
